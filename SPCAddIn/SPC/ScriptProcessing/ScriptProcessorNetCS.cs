//=============================================================================
//
//D ScriptProcessorNetCS class - implements C# script language processor
//
// ----------------------------------------------------------------------------
...
namespace Autodesk.PowerInspect.AddIns.SPC
{
  ...
  /// C# script processor
  /// </summary>
  internal class ScriptProcessorNetCS : Autodesk.PowerInspect.AddIns.SPC.ScriptProcessorNet
  {
    ...
    //=============================================================================
    /// <summary>
    /// ScriptProcessorNetCS class constructor
    /// </summary>
    /// <param name="aScriptSource">source code of script</param>
    internal ScriptProcessorNetCS(string aScriptSource)
    {
      ...
      foreach (System.CodeDom.Compiler.CompilerError err in m_compilerResults.Errors) {
        MessageBox.Show(
      ...
      Debug.Assert(m_spcOuputFormatter!=null,"ScriptProcessorNetCS.ScriptProcessorNetCS(): Can't create instance of class "+sp_MAIN_CLASS_NAME);
