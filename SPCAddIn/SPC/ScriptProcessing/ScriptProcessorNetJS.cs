...
namespace Autodesk.PowerInspect.AddIns.SPC
{
  //=============================================================================
  /// <summary>
  /// JScript.NET script processor
  /// </summary>
  internal class ScriptProcessorNetJS : Autodesk.PowerInspect.AddIns.SPC.ScriptProcessorNet
  {
    ...
    //=====================================================================================
    /// <summary>
    /// ScriptProcessorNetJS class constructor
    /// </summary>
    /// <param name="aScriptSource">source code of script</param>
    internal ScriptProcessorNetJS(string aScriptSource)
    {
      m_codeDomProvider = new JScriptCodeProvider();
      ...
      Debug.Assert(m_spcOuputFormatter!=null,"ScriptProcessorNetJS.ScriptProcessorNetJS(): Can't create instance of class "+sp_MAIN_CLASS_NAME);
